...
var forwardSlasesAfterRoot = process
  .cwd()
  .substr(process.cwd().indexOf("e2eTests"))
  .match(/\//g);
var numForwardSlashes = forwardSlasesAfterRoot
  ? forwardSlasesAfterRoot.length
  : 0;

var cwd = process.cwd();
for (var i = 0; i < numForwardSlashes; i += 1) {
  cwd += "/..";
}
...
var handlePackager = function handlePackager(fructosePackager) {
  return new Promise(function(resolve, reject) {
    ...
    fructosePackager.stderr.on("data", function() {
...
var startPackager = (exports.startPackager = function startPackager() {
  var fructosePackager = (0, _child_process.spawn)(
    "npm",
    ["run", "fructose-app"],
    { cwd: cwd }
  );
